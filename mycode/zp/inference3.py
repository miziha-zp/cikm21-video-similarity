...
def main():
    ...
    if valid:
        ...
        two_stage_file = '../embedding/test_bitm_vision_transdp01_bertlast_valid.pkl'
    else:
        files = args.test_b_file
        args.output_json = 'result.json'
        args.output_zip = 'result.zip'
        two_stage_file = '../embedding/test_bitm_vision_transdp01_bertlast_test.pkl'
    ...
    args.ckpt_file = 'save/model3/ckpt-28000'
