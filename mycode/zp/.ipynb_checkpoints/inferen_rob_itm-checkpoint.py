...
def main():
    ...
    if valid:
        ...
        two_stage_file = '../embedding/test_robitm_vision_transdp01_bertlast_valid.pkl'
    else:
        files = args.test_b_file
        args.output_json = 'result.json'
        args.output_zip = 'result.zip'
        two_stage_file = '../embedding/test_robitm_vision_transdp01_bertlast_test.pkl'
    ...
    args.ckpt_file = 'save/roberta_itm_vision_trans1e_5/ckpt-28000'
