...
parser.add_argument('--ckpt-file', type=str, default='save/v1/ckpt-100000')
...
# ========================== Title BERT =============================
parser.add_argument('--bert-dir', type=str, default='/data03/yrqUni/Workspace/QQB/Data/chinese-roberta-wwm-ext')
...
# ====================== Fusion Configs ===========================
parser.add_argument('--hidden-size', type=int, default=512, help='NO MORE THAN 256')
