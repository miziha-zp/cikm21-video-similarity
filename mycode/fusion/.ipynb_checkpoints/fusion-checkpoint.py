...
ich_valid = joblib.load('../embedding/ICH_valid.pkl')
ich_test = joblib.load('../embedding/ICH_test.pkl')
...
valid_knowledgePool_t = baseline_valid + roberta_valid + zlh_trans_valid + baseline_valid2 + ich_valid + yrq_bert_valid[:3]+yrq_roberta_valid[:3]
test_knowledgePool_t = baseline_test + roberta_test + zlh_trans_test + baseline_test2 + ich_test + yrq_bert_test[:3] + yrq_roberta_test[:3]
